    ...
    <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-t border-gray-200">
      <div className="flex-1 flex justify-between sm:hidden">
        <button
          ...
          className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 transition-all active:scale-95"
        >
          Trang trước
        </button>
        <button
          ...
          className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 transition-all active:scale-95"
        >
          Trang sau
        </button>
      </div>
      <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-500 font-medium">
            Hiển thị <span className="font-extrabold text-gray-900">{(currentPage - 1) * 10 + 1}</span> -{" "}
            <span className="font-extrabold text-gray-900">{Math.min(currentPage * 10, totalItems)}</span> trong tổng số{" "}
            <span className="font-extrabold text-gray-900">{totalItems}</span> người dùng
          </p>
        </div>
        <div>
